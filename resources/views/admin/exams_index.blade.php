...
<body class="bg-gray-100 font-sans text-gray-800 flex h-screen overflow-hidden">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        {{-- Top header --}}
        <header class="bg-white border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 shadow-sm">
            <div class="flex items-center gap-2 min-w-0 max-w-full">
                @include('admin.partials.header_button')
                <span class="text-xs sm:text-sm font-black text-gray-600 uppercase tracking-wider shrink-0">Module:</span>
                <span class="bg-orange-100 text-brandOrange text-[9px] font-black px-2.5 py-0.5 rounded border border-orange-200 tracking-widest uppercase shadow-sm break-words whitespace-normal leading-tight">
                    Exams Management &amp; Multi-Exam Roster
                </span>
            </div>
            <div class="flex flex-wrap items-center gap-2 sm:gap-3 w-full md:w-auto">
                <a href="{{ route('public.exams_board') }}" target="_blank"
                   class="bg-gray-100 hover:bg-gray-200 text-gray-700 text-[11px] sm:text-xs font-black px-2.5 sm:px-3 py-1.5 rounded-lg border border-gray-300 uppercase transition flex items-center gap-1">
                    <span>🌐</span> View Public Board
                </a>
                <a href="{{ route('exam.form') }}" target="_blank"
                   class="bg-emerald-50 hover:bg-emerald-100 text-emerald-700 text-[11px] sm:text-xs font-black px-2.5 sm:px-3 py-1.5 rounded-lg border border-emerald-300 uppercase transition flex items-center gap-1">
                    <span>📝</span> Live Application Form
                </a>
                <button onclick="openCreateModal()"
                        class="bg-brandOrange hover:bg-orange-700 text-white text-[11px] sm:text-xs font-black px-3 sm:px-4 py-1.5 rounded-lg shadow-sm uppercase tracking-wide transition flex items-center gap-1 cursor-pointer">
