            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                    <div class="p-3 bg-gray-50 rounded-lg border border-gray-100 flex flex-col justify-between">
                        <div>
                            <span class="font-black text-gray-800 block text-xs">1. Health Declaration</span>
                    ...
                    <div class="p-3 bg-gray-50 rounded-lg border border-gray-100 flex flex-col justify-between">
                        <div>
                            <span class="font-black text-gray-800 block text-xs">2. Family Sheet</span>
                    ...
                    <div class="p-3 bg-gray-50 rounded-lg border border-gray-100 flex flex-col justify-between">
                        <div>
                            <span class="font-black text-gray-800 block text-xs">3. ID Proof Copy</span>
                    ...
                    <div class="p-3 bg-gray-50 rounded-lg border border-gray-100 flex flex-col justify-between">
                        <div>
                            <span class="font-black text-gray-800 block text-xs">4. Bank Proof</span>
