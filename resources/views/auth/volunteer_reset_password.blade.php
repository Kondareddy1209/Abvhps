...
@section('title', 'Reset Password | ABVHPS Volunteer Portal')
    ...
    <div class="max-w-md w-full space-y-6">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-orange-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-orange-700 via-orange-600 to-amber-600 p-6 text-center text-white">
                ...
                <h2 class="text-lg font-black uppercase tracking-tight">Set New Password</h2>
                <p class="text-orange-100 text-xs font-semibold mt-1">
                    ABVHPS Volunteer Security System
                </p>
            </div>
            ...
            <div class="p-6 sm:p-8 space-y-5">
                ...
                <form method="POST" action="{{ route('volunteer.reset_password.submit') }}" class="space-y-4">
                    @csrf
                    <input type="hidden" name="token" value="{{ $token }}">

                    <div>
                        <label for="email" class="block text-xs font-black text-gray-700 uppercase tracking-wider mb-1.5">
                            Registered Email Address <span class="text-orange-600">*</span>
                        </label>
                        <input
                            type="email"
                            id="email"
                            ...
                            required
                            readonly
                            class="w-full bg-gray-100 border border-gray-300 rounded-xl px-4 py-3 text-sm font-medium text-gray-700 outline-none"
                        >
                    </div>

                    <div>
                        <label for="password" class="block text-xs font-black text-gray-700 uppercase tracking-wider mb-1.5">
                            New Password <span class="text-orange-600">*</span>
                        </label>
                        <input
                            type="password"
                            id="password"
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-xs font-black text-gray-700 uppercase tracking-wider mb-1.5">
                    ...
                    >
                        Reset Password &amp; Continue to Login →
                    </button>
